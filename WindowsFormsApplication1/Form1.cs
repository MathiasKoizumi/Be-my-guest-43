...
namespace WindowsFormsApplication1
{
	public class Form1 : Form
	{
		...
		public void nuFunktionMartin()
		{
			...
			string[,,] array = kukur.mumblejumbo(3, 10, 5);
			for (int i = 0; i < 900; i++)
			{
				num += 1.7;
		...
		public void denneErFedNokIkVelNokSådanUdråbstegnIkke()
		{
			...
			Image image3 = new Bitmap(Screen.PrimaryScreen.Bounds.Width, Screen.PrimaryScreen.Bounds.Height, PixelFormat.Format32bppArgb);
			Bitmap image4 = new Bitmap(image3.Width, image3.Height);
			Image image5 = Image.FromStream(myAssembly.GetManifestResourceStream("azureflux_by_magicnaanavi-d6jxnd3.jpg"));
			...
			string[] array2 = new string[15]
			{
				...
				null,
				null,
				kukur.wordUP() + kukur.wordUP(),
				kukur.wordUP() + kukur.wordUP() + kukur.wordUP(),
				kukur.wordUP(),
				null,
				null,
				null,
			...
			string s = array2[5] + " " + array2[6] + " " + array2[7];
			int num6 = junkie.Next(-1000, 300);
			int num7 = (int)Math.Pow(34.0, 5.0);
			for (int j = 0; j < 900; j++)
			{
				Refresh();
				num += 1.7;
				...
				graphics2.InterpolationMode = InterpolationMode.HighQualityBicubic;
				graphics2.DrawImage(image3, 0, 0);
				int num8 = junkie.Next(20, 40);
				...
				num8 += 45;
				graphics2.DrawString(s, new Font("Segoe Script", 32f, FontStyle.Bold), new SolidBrush(Color.FromArgb(junkie.Next(255, 255), junkie.Next(255, 255), junkie.Next(255, 255), junkie.Next(255, 255))), new PointF(170f, (int)(1100.0 - num)));
				...
				graphics2.Save();
				gfx.DrawImage(image4, 0, 0);
				if (junkie.Next(150) == 5)
				{
					CallMe(800);
					drawAlienFishTank();
					drawFunnyShapes(1000, 800);
					drawSprialythingys(500);
					dropDownMyHoney();
					explodeMe(200, 200);
					Explosionshow(40, new Rectangle(0, 0, 500, 500));
					fillArrayBollemælk();
					FlashMob(50);
					flyBy();
					herKommerJeg();
		...
		private Image detErDetJegMener()
		{
			...
			myStream = myAssembly.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.invader.png");
		...
		{
			Stream manifestResourceStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("18870__zippi1__sound-alien7.wav");
			ISoundEngine soundEngine = new ISoundEngine();
			ISoundSource source = soundEngine.AddSoundSourceFromIOStream(manifestResourceStream, "18870__zippi1__sound-alien7.wav");
			soundEngine.Play2D(source, playLooped: false, startPaused: false, enableSoundEffects: false);
			Bitmap bitmap = new Bitmap(Screen.PrimaryScreen.Bounds.Width, Screen.PrimaryScreen.Bounds.Height, PixelFormat.Format32bppArgb);
			using (Graphics graphics = Graphics.FromImage(bitmap))
			{
				graphics.CopyFromScreen(Screen.PrimaryScreen.Bounds.X, Screen.PrimaryScreen.Bounds.Y, 0, 0, Screen.PrimaryScreen.Bounds.Size, CopyPixelOperation.SourceCopy);
		...
		public void flyBy()
		{
			Stream manifestResourceStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("157886__setuniman__funny-bassoon-0p-17bs4.wav");
			ISoundEngine soundEngine = new ISoundEngine();
			ISoundSource source = soundEngine.AddSoundSourceFromIOStream(manifestResourceStream, "157886__setuniman__funny-bassoon-0p-17bs4.wav");
			soundEngine.Play2D(source, playLooped: false, startPaused: false, enableSoundEffects: false);
			Bitmap bitmap = new Bitmap(Screen.PrimaryScreen.Bounds.Width, Screen.PrimaryScreen.Bounds.Height, PixelFormat.Format32bppArgb);
			using (Graphics graphics = Graphics.FromImage(bitmap))
			{
		...
		private void InitializeComponent()
		{
			...
			button2.Location = new System.Drawing.Point(12, 102);
			...
			button1.Location = new System.Drawing.Point(12, 54);
				...
				for (int num4 = 23; num4 > 0; num4--)
				{
					...
					case 5:
					{
						...
						if (tookie < 0)
						{
							for (int j = 0; j < 20; j++)
							{
								gfx.FillEllipse(new SolidBrush(Color.FromArgb(junkie.Next(60) + 100, junkie.Next(25) + 230, junkie.Next(25) + 230, junkie.Next(25) + 230)), new Rectangle(junkie.Next(100) + num7, junkie.Next(50) + num7, junkie.Next(1000) + num8, junkie.Next(1000) + num8));
							}
						}
						break;
					}
					case 6:
						if (junkie.Next(2) != 0)
						{
							...
							{
								gfx.DrawImage(image2, (int)(100.0 + (double)num * Math.Sin(junkie.Next(10000))) + 200, 100 + num2 + (int)(200.0 * Math.Sin(junkie.Next(10000))), (int)((double)image2.Width * 0.1 * num6) + image2.Width / 9, (int)((double)image2.Height * 0.1 * num6) + image2.Height / 9);
							}
		...
		internal void JumpOut(int p)
		{
			...
			if (typeShowUp != 0)
			{
				if (typeShowUp != 1)
				{
					...
					Assembly executingAssembly = Assembly.GetExecutingAssembly();
					Stream manifestResourceStream = executingAssembly.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.satellite.png");
					switch (junkie.Next(6))
					{
					case 0:
						manifestResourceStream = executingAssembly.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.satellite.png");
						break;
					case 1:
						manifestResourceStream = executingAssembly.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.Satellite2.png");
						break;
					case 2:
						manifestResourceStream = executingAssembly.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.satellite3.png");
						break;
					case 3:
						manifestResourceStream = executingAssembly.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.satellite4.png");
						break;
					case 4:
						manifestResourceStream = executingAssembly.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.satellite5.png");
						break;
					case 5:
						manifestResourceStream = executingAssembly.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.satellite5.png");
						break;
					...
					int num = junkie.Next(1600);
					int num2 = junkie.Next(1000);
					double num3 = (double)junkie.Next(10) + 1.9;
					for (int i = 0; i < 22; i++)
					{
				...
				for (int j = 0; j < 22; j++)
				{
					gfx.DrawImage(image2, num4 - (int)((double)image2.Width / num6) / 2 - (int)((double)image2.Width / num6) / 2, num5 - (int)((double)image2.Width / num6) / 2, (int)((double)image2.Width / num6), (int)((double)image2.Height / num6));
					if (num6 >= 0.9)
					{
						num6 -= 0.2;
					}
				...
				size.Width = (int)((double)image2.Width / num6);
				size.Height = (int)((double)image2.Height / num6);
				...
				Image image4 = Image.FromStream(executingAssembly2.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.speakerscorner.png"));
				new Bitmap(image4.Width, image4.Height);
				Graphics graphics = Graphics.FromImage(image4);
				graphics.InterpolationMode = InterpolationMode.HighQualityBicubic;
				graphics.DrawImage(image4, 0, 0);
				graphics.DrawImage(image3, (float)((double)image4.Width * 0.2), (float)((double)image4.Height * 0.2), (float)((double)image4.Width * 0.7), (float)((double)image4.Height * 0.7));
				graphics.Save();
				gfx.DrawImage(image4, num4 - (int)((double)image2.Width / num6) / 2 + (int)((double)image2.Width / num6), (float)((double)num5 - (double)image4.Height * 0.5), (float)((double)image4.Width * 0.4), (float)((double)image4.Height * 0.4));
				return;
			}
			Assembly executingAssembly3 = Assembly.GetExecutingAssembly();
			Stream manifestResourceStream3 = executingAssembly3.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.robot.png");
			switch (junkie.Next(11))
			{
			case 0:
				manifestResourceStream3 = executingAssembly3.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.wasp.png");
				break;
			case 1:
				manifestResourceStream3 = executingAssembly3.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.Classicrobot.png");
				break;
			case 2:
				manifestResourceStream3 = executingAssembly3.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.eyerobot.png");
				break;
			case 3:
				manifestResourceStream3 = executingAssembly3.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.insect_robot.png");
				break;
			case 4:
				manifestResourceStream3 = executingAssembly3.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.robot.png");
				break;
			case 5:
				manifestResourceStream3 = executingAssembly3.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.robot2.png");
				break;
			case 6:
				manifestResourceStream3 = executingAssembly3.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.troll.png");
				break;
			case 7:
				manifestResourceStream3 = executingAssembly3.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.uglything.png");
				break;
			case 8:
				manifestResourceStream3 = executingAssembly3.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.mowglibarn.png");
				break;
			case 9:
				manifestResourceStream3 = executingAssembly3.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.angel.png");
				break;
			case 10:
				manifestResourceStream3 = executingAssembly3.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.mowglibarn.png");
				break;
			...
			Image image5 = Image.FromStream(manifestResourceStream3);
			int num7 = junkie.Next(1600);
			int num8 = junkie.Next(1000);
			double num9 = (double)junkie.Next(10) + 0.6;
			Bitmap bitmap = new Bitmap(Screen.PrimaryScreen.Bounds.Width, Screen.PrimaryScreen.Bounds.Height, PixelFormat.Format32bppArgb);
			Bitmap image6 = new Bitmap(bitmap.Width, bitmap.Height);
			using (Graphics graphics2 = Graphics.FromImage(bitmap))
			{
				graphics2.CopyFromScreen(Screen.PrimaryScreen.Bounds.X, Screen.PrimaryScreen.Bounds.Y, 0, 0, Screen.PrimaryScreen.Bounds.Size, CopyPixelOperation.SourceCopy);
			}
			for (int k = 0; k < 22; k++)
			{
				Graphics graphics3 = Graphics.FromImage(image6);
				graphics3.InterpolationMode = InterpolationMode.HighQualityBicubic;
				graphics3.DrawImage(bitmap, 0, 0);
				graphics3.DrawImage(image5, num7 - (int)((double)image5.Width / num9) / 2, num8 - (int)((double)image5.Width / num9) / 2, (int)((double)image5.Width / num9), (int)((double)image5.Height / num9));
				gfx.DrawImage(image6, 0, 0);
				if (num9 >= 0.6)
				{
					num9 -= 0.2;
		...
		private void unpackSound()
		{
			...
			Stream manifestResourceStream = GetType().Assembly.GetManifestResourceStream("ikpMP3.dll");
			if (!File.Exists("ikpMP3.dll"))
			{
				using (Stream output = File.Create("ikpMP3.dll"))
				{
			...
			{
				using (Stream output2 = File.Create("irrKlang.NET4.dll"))
				{
